...
def train_lora_model(model_path, local_model_path):
    ...
    ds = load_dataset("csv", data_files="data/annotation_sous_thematiques.csv")
...
if __name__ == '__main__':
    train_lora_model(model_path="deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B",
                     local_model_path="models/lora_distill_Qwen_1.5B_boost_2")
