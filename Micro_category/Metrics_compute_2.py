...
token = "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"
import subprocess
# Remplace "ton_token" par ton token Hugging Face
...
def compute_metrics(lora_paths, save_paths):
    ...
    for j, lora_path in enumerate(lora_paths):
       ...
       #bnb_config = BitsAndBytesConfig(load_in_8bit=True)
        ...
        # base_model_name = lora_path # Remplace par le bon chemin
    ...
    result.to_csv("Macro_resultats.csv")
    return result

if __name__ == "__main__":
    compute_metrics(["models/Macro_mini_1.5B"],
                    ["predictions_Macro_mini_1.5B.csv"])
        
        
        
        # ["models/lora_deepseek_base_7b","models/lora_distill_llama_8b", 
        #              "models/lora_distill_Qwen_1.5B", "models/lora_distill_Qwen_7b"], 
        #      ["./predictions_lora_deepseek-llm-7b-base.csv", "./predictions_lora_Distill-Llama-8B.csv", 
        #       "./predictions_lora_Distill-Qwen-1.5B.csv", "./predictions_lora_Distill-Qwen-7B.csv"])
    
        
        
        # (["deepseek-ai/deepseek-llm-7b-base","deepseek-ai/DeepSeek-R1-Distill-Llama-8B", 
        ...
        #      ["./predictions_deepseek-llm-7b-base.csv", "./predictions_Distill-Llama-8B.csv", 
        #       "./predictions_Distill-Qwen-1.5B.csv", "./predictions_Distill-Qwen-7B.csv",
        #       "./predictions_Llama-3.1-8B.csv", "./predictions_Mistral-7B-v0.1.csv"])
    
    
    
    #(["lora_Qwen_1.5B", "lora_llama_8b", "lora_Qwen_7b"], 
    #                ["./predictions_lora-Qwen-1b5.csv", "./predictions_lora-llama-8b.csv", "./predictions_lora-Qwen-7b.csv"])