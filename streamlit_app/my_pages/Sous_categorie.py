...
def show():
    ...
    # ======================================================
    # 3. Pagination : Affichage de 100 lignes par page
    # ======================================================
        ...
        # ======================================================
    # Filtrer par catégorie (présente dans l'une des 3 colonnes)
    # ======================================================
    st.markdown("### Filtre par catégorie")
    ...
    # Combine les 3 colonnes de prédiction en une seule série
    all_preds = pd.concat([
    ...
    with col2:
        ...
        # Légende avec % entre parenthèses
        ax2.legend(
            wedges,
            labels_with_percent,
            title="Catégories",
