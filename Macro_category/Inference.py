...
def compute_metrics(lora_paths, save_paths, full=True):
    ...
    for j, lora_path in enumerate(lora_paths):
        ...
        path = "data/Annotations_macro_thematiques.csv"
...
if __name__ == "__main__":
    compute_metrics(lora_paths=["./models/Macro_lora_8B"],
                    save_paths=["predictions_Macro_lora_8B.csv"],
                    full=False)
